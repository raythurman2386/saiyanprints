...
const items = [{
    ...
    description: 'Need something for a Halloween costume, cosplay outfit or just random toys and gifts for the holidays? We have a ton of options that we can print out for you!'
},{
    icon: <Laptop size={70} color="#1eb854"/>,
    title: 'Custom Designs',
    description: 'Need a hard to find part that can easily be designed in software and printed? Give us the dimensions or the old piece and we can make one from scratch!'
},{
    icon: <Printer size={70} color="#1eb854"/>,
    title: '3D Printing Service',
    description: 'Have a .stl file from thingiverse, cults3d, or thangs and need it printed? We can send a quote before printing to see the cost beforehand!'
},]
